...
By default, for each change in the PR will automatically trigger pytests, Serverless AWS deployment via Travis CI as well as a code quality review via [Codacy](https://www.codacy.com/). If either Travis CI or Codacy fails make sure to address the failures immediately.
